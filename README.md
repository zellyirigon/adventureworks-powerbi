...
A Power BI project analysing sales and returns data from the AdventureWorks dataset.

Built as part of my PL-300 preparation, with focus on data modelling, DAX and report design.
...
| MySQL / SQL | Source data exploration |
...
| Sales Overview | Revenue, orders and trends over time | 🔄 In progress |

| Product Performance | Top products, categories and return rates | ⏳ Planned |

| Regional Analysis | Sales by territory and region | ⏳ Planned |
